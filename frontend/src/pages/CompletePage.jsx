...
const SuccessIcon = (
  <svg className="w-6 h-6" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function CompletePage() {
  ...
  return (
    <div className="flex justify-center items-center font-bold text-lg">
      <div className="font-bold text-lg shadow-md rounded-lg p-8 max-w-md w-full space-y-6 animate-fade-in ">
        <div className={`flex justify-center items-center h-12 w-12 rounded-full ${STATUS_CONTENT_MAP[status].iconColor} text-white mx-auto`}>
            ...
            <table className="w-full text-sm">
              <tbody>
                <tr className="border-t border-gray-200">
                  <td className="py-2 font-semibold text-gray-800">ID</td>
                  <td className="py-2 text-right text-gray-600">{intentId}</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-2 font-semibold text-gray-800">Status</td>
                  <td className="py-2 text-right text-gray-600">{status}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {intentId && (
          ...
          >
            View details
            <svg className="w-4 h-4 ml-1" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a 
          href="/payment"
          className="block w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-center transition duration-150 ease-in-out"
        >
          Test another
        </a>
      </div>
